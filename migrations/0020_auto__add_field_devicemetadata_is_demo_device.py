...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceMetadata.is_demo_device'
        db.add_column('securesync_devicemetadata', 'is_demo_device',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceMetadata.is_demo_device'
        db.delete_column('securesync_devicemetadata', 'is_demo_device')
