...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'playlist_quizlog', (
            ...
            ('quiz', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ...
            ('total_correct', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('response_log', self.gf('django.db.models.fields.TextField')(default='[]')),
        ))
        db.send_create_signal(u'playlist', ['QuizLog'])

    def backwards(self, orm):
        # Deleting model 'QuizLog'
        db.delete_table(u'playlist_quizlog')
    ...
    models = {
        ...
        u'playlist.playlisttogroupmapping': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'playlist': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'})
        },
        u'playlist.quizlog': {
