...
var NarrativeModel = Backbone.Model.extend({
    ...
    sync: function(method, model, options) {
        ...
        // console.log("inline/models.js options:");
        // console.log(options);
        // console.log("Inside inline/models.js, sync()");
        url();
    },

    url: function() {
        // console.log("HELLO THIS IS RELATIVE URL");
        // console.log(window.location.pathname);
        // console.log("HELLO THIS IS ID:");
        // console.log(this.get("id"));

         //or some url that we've defined that holds yaml or w/e?
