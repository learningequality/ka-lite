    ...
    make3dObject: function (verts, options) {
        ...
        object.addFace = function (options) {
            ...
            face.normal = function () {
                ...
                return _.map(normal, function (e) {
                    return e / length;
                });
            };
            ...
            face.drawBorder = function () {
                return graph.path(face.mappedVerts().concat(true), {
                    fill: null,
                    stroke: '#666',
                    opacity: 1
                });
            ...
            face.drawLines = function () {
                ...
                _.each(this.lines, function (line) {
                    set.push(graph.line(object.doProjection(line[0]), object.doProjection(line[1]), {
                        stroke: 'black',
                        strokeDasharray: '. '
                    }));
                });
        ...
        object.addSketch = function (options) {
            ...
            sketch.path = function () {
                return graph.path(sketch.mappedVerts(), {
                    fill: sketch.color,
                    stroke: true
                });
            };
...
},{"./graphie.js":4,"./kmatrix.js":5,"./kvector.js":8}],4:[function(require,module,exports){
...
},{"./kpoint.js":7,"./kvector.js":8,"./tex.js":9,"./tmpl.js":10}],5:[function(require,module,exports){
...
},{"./expressions.js":2}],6:[function(require,module,exports){
...
},{"./knumber.js":6,"./kvector.js":8}],8:[function(require,module,exports){
var knumber = require('./knumber.js');
...
},{"./knumber.js":6}],9:[function(require,module,exports){
