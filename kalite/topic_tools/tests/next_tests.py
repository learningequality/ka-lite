...
from kalite.topic_tools.content_recommendation import get_group_recommendations, get_struggling_exercises, \
...
class TestNextMethods(KALiteTestCase):
    ...
    def setUp(self):
        ...
        self.original_exerciselog3 = ExerciseLog(exercise_id=self.EXERCISE_ID_STRUGGLE, user=self.user2,
                                                 struggling=True)
