...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoLog.latest_activity_timestamp'
        db.add_column(u'main_videolog', 'latest_activity_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContentLog.latest_activity_timestamp'
        db.add_column(u'main_contentlog', 'latest_activity_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExerciseLog.latest_activity_timestamp'
        db.add_column(u'main_exerciselog', 'latest_activity_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ContentLog.latest_activity_timestamp'
        db.delete_column(u'main_contentlog', 'latest_activity_timestamp')
