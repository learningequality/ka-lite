...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_attemptlog', (
            ...
            ('answer_given', self.gf('django.db.models.fields.TextField')()),
            ...
            ('context_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('exercise_version', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
    ...
    models = {
        'main.attemptlog': {
            ...
            'exercise_version': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
