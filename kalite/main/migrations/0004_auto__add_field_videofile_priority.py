...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoFile.priority'
        db.add_column('main_videofile', 'priority', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VideoFile.priority'
        db.delete_column('main_videofile', 'priority')
