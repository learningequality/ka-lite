...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentLog.progress'
        db.alter_column(u'main_contentlog', 'progress', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ContentLog.progress'
        db.alter_column(u'main_contentlog', 'progress', self.gf('django.db.models.fields.IntegerField')(null=True))
