...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LanguagePack.crowdin_version'
        db.delete_column('main_languagepack', 'crowdin_version')

        # Adding field 'LanguagePack.language_pack_version'
        db.add_column('main_languagepack', 'language_pack_version',
