...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoLog.completion_timestamp'
        db.add_column('main_videolog', 'completion_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoLog.completion_counter'
        db.add_column('main_videolog', 'completion_counter',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoLog.completion_timestamp'
        db.delete_column('main_videolog', 'completion_timestamp')

        # Deleting field 'VideoLog.completion_counter'
        db.delete_column('main_videolog', 'completion_counter')
