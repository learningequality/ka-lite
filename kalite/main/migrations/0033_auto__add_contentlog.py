...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContentLog'
        db.create_table(u'main_contentlog', (
            ...
            ('completion_counter', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('time_spent', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('content_source', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ...
            ('extra_fields', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
    ...
    models = {
        ...
        u'main.contentlog': {
            ...
            'content_source': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'counter': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
