...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'ContentLog', fields ['content_source']
        db.delete_index(u'main_contentlog', ['content_source'])

        # Removing index on 'ContentLog', fields ['content_kind']
        db.delete_index(u'main_contentlog', ['content_kind'])

        # Adding index on 'ContentLog', fields ['user', 'content_id']
        db.create_index(u'main_contentlog', ['user_id', 'content_id'])


    def backwards(self, orm):
        # Removing index on 'ContentLog', fields ['user', 'content_id']
        db.delete_index(u'main_contentlog', ['user_id', 'content_id'])

        # Adding index on 'ContentLog', fields ['content_kind']
        db.create_index(u'main_contentlog', ['content_kind'])

        # Adding index on 'ContentLog', fields ['content_source']
        db.create_index(u'main_contentlog', ['content_source'])
    ...
    models = {
        ...
        u'main.contentlog': {
            'Meta': {'object_name': 'ContentLog', 'index_together': "[['user', 'content_id']]"},
            'complete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'content_kind': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'content_source': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'counter': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
