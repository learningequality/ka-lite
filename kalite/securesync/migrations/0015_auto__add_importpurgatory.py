...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImportPurgatory'
        db.create_table('securesync_importpurgatory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('counter', self.gf('django.db.models.fields.IntegerField')()),
            ('retry_attempts', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('serialized_models', self.gf('django.db.models.fields.TextField')()),
            ('exceptions', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('securesync', ['ImportPurgatory'])


    def backwards(self, orm):
        # Deleting model 'ImportPurgatory'
        db.delete_table('securesync_importpurgatory')
