...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityUser.is_teacher'
        db.add_column('securesync_facilityuser', 'is_teacher', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityUser.is_teacher'
        db.delete_column('securesync_facilityuser', 'is_teacher')
