...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facility.contact_name'
        db.add_column('securesync_facility', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Facility.contact_phone'
        db.add_column('securesync_facility', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Facility.contact_email'
        db.add_column('securesync_facility', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Facility.user_count'
        db.add_column('securesync_facility', 'user_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facility.contact_name'
        db.delete_column('securesync_facility', 'contact_name')

        # Deleting field 'Facility.contact_phone'
        db.delete_column('securesync_facility', 'contact_phone')

        # Deleting field 'Facility.contact_email'
        db.delete_column('securesync_facility', 'contact_email')

        # Deleting field 'Facility.user_count'
        db.delete_column('securesync_facility', 'user_count')
