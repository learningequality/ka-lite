...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.public_key'
        db.alter_column('securesync_device', 'public_key', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Device.public_key'
        db.alter_column('securesync_device', 'public_key', self.gf('django.db.models.fields.CharField')(max_length=200))
