...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facility.zoom'
        db.add_column('securesync_facility', 'zoom', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Facility.zoom'
        db.delete_column('securesync_facility', 'zoom')
