...
class SyncClient(object):
    ...
    def __init__(self, host="%s://%s/"%(settings.SECURESYNC_PROTOCOL,settings.CENTRAL_SERVER_HOST.replace("playground.learningequality.org","10.28.237.39")), require_trusted=True):
