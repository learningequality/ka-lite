...
class FacilityGroup(DeferredCountSyncedModel):
    ...
    description = models.TextField(blank=True, verbose_name=_("Description")); description.minversion = "0.12.0" # TODO-BLOCKER(jamalex): change this to the specific version it is at the time it ships
