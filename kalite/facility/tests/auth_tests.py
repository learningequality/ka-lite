...
class FacilityUserPermissionsTests(CreateAdminMixin,
    ...
    def add_student(self):
        ...
        self.assertFalse(self.browser.find_element_by_id("id_is_teacher").get_attribute('value') == 'True',
                         "While creating student, 'is_teacher' checkbox selected.")
    ...
    def edit_student(self, message_contains="Changes saved for"):
        ...
        self.submit_and_wait(
            self.reverse('facility_management', kwargs={'zone_id': 'None', 'facility_id': self.facility.id}), "success",
            message_contains)

    def add_teacher(self):
        self.browse_to(self.add_teacher_url)
        self.fill_form(self.teacher_form_data)
        self.assertTrue(self.browser.find_element_by_id("id_is_teacher").get_attribute('value') == 'True',
                        "While creating teacher, 'is_teacher' checkbox not selected.")
        self.submit_and_wait(self.add_student_url, "success", "You successfully created")
