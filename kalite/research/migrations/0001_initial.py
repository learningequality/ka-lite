...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('research_experimentlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['securesync.FacilityUser'])),
            ('activity_stage', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('research', ['ExperimentLog'])


    def backwards(self, orm):
        # Deleting model 'ExperimentLog'
        db.delete_table('research_experimentlog')
