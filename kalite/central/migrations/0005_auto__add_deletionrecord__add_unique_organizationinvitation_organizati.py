...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeletionRecord'
        db.create_table('central_deletionrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['central.Organization'])),
            ('deleter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deletion_actor', to=orm['auth.User'])),
            ('deleted_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deletion_recipient', to=orm['auth.User'])),
            ('deleted_invite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['central.OrganizationInvitation'])),
        ))
        db.send_create_signal('central', ['DeletionRecord'])

        # Adding unique constraint on 'OrganizationInvitation', fields ['organization', 'email_to_invite']
        db.create_unique('central_organizationinvitation', ['organization_id', 'email_to_invite'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationInvitation', fields ['organization', 'email_to_invite']
        db.delete_unique('central_organizationinvitation', ['organization_id', 'email_to_invite'])

        # Deleting model 'DeletionRecord'
        db.delete_table('central_deletionrecord')
    ...
    models = {
        ...
        'central.deletionrecord': {
            ...
            'deleted_invite': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['central.OrganizationInvitation']"}),
            'deleted_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deletion_recipient'", 'to': "orm['auth.User']"}),
