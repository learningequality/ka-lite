...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeletionRecord.deleted_invite'
        db.alter_column('central_deletionrecord', 'deleted_invite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['central.OrganizationInvitation'], null=True))

        # Changing field 'DeletionRecord.deleted_user'
        db.alter_column('central_deletionrecord', 'deleted_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DeletionRecord.deleted_invite'
        raise RuntimeError("Cannot reverse this migration. 'DeletionRecord.deleted_invite' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeletionRecord.deleted_user'
        raise RuntimeError("Cannot reverse this migration. 'DeletionRecord.deleted_user' and its values cannot be restored.")
