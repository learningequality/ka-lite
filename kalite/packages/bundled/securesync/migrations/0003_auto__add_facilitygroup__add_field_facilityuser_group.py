...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacilityGroup'
        db.create_table('securesync_facilitygroup', (
        ...
        db.send_create_signal('securesync', ['FacilityGroup'])

        # Adding field 'FacilityUser.group'
        db.add_column('securesync_facilityuser', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['securesync.FacilityGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FacilityGroup'
        db.delete_table('securesync_facilitygroup')

        # Deleting field 'FacilityUser.group'
        db.delete_column('securesync_facilityuser', 'group_id')
