...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SyncSession.client_os'
        db.alter_column('securesync_syncsession', 'client_os', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'SyncSession.client_version'
        db.alter_column('securesync_syncsession', 'client_version', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'SyncSession.client_os'
        db.alter_column('securesync_syncsession', 'client_os', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'SyncSession.client_version'
        db.alter_column('securesync_syncsession', 'client_version', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
