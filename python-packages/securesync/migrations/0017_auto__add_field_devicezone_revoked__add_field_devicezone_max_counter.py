...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceZone.revoked'
        db.add_column('securesync_devicezone', 'revoked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DeviceZone.max_counter'
        db.add_column('securesync_devicezone', 'max_counter',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceZone.revoked'
        db.delete_column('securesync_devicezone', 'revoked')

        # Deleting field 'DeviceZone.max_counter'
        db.delete_column('securesync_devicezone', 'max_counter')
