...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportPurgatory.model_count'
        db.add_column('securesync_importpurgatory', 'model_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportPurgatory.model_count'
        db.delete_column('securesync_importpurgatory', 'model_count')
