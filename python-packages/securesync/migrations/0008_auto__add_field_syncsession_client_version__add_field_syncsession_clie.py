...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncSession.client_version'
        db.add_column('securesync_syncsession', 'client_version',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SyncSession.client_os'
        db.add_column('securesync_syncsession', 'client_os',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncSession.client_version'
        db.delete_column('securesync_syncsession', 'client_version')

        # Deleting field 'SyncSession.client_os'
        db.delete_column('securesync_syncsession', 'client_os')
    ...
    models = {
        ...
        'securesync.syncsession': {
            ...
            'client_os': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'client_version': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
