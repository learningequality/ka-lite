...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facility.active_unit'
        db.add_column(u'securesync_facility', 'active_unit',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Facility.active_unit'
        db.delete_column(u'securesync_facility', 'active_unit')
    ...
    models = {
        ...
        'securesync.facility': {
            ...
            'active_unit': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
